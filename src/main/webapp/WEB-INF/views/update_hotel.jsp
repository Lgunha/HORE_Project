         ...
         <div class="col-md-8">
            ...
            <form action="update_hotel_save" method="post"
               ...
               <div class="input-group mb-3" >
                ...
                <input type="submit"
                  value="숙소 정보 수정" style="margin-top: 15px;"
