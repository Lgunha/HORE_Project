...
<div class="container text-center">
      ...
      <div class="row">
         <div class="col-md-8">
            ...
            <h3> 방 정보 수정 </h3>
            <form action="update_room_save" method="post"
               encType="multipart/form-data">
               <input type="hidden" name="detailAddr_room" value="${roomvo.detailAddr_room }"><br>
			   <input type="hidden" name="detailAddr_roomNum_room" value="${roomvo.detailAddr_roomNum_room }">
               <div class="input-group mb-3">
                  <span class="input-group-text" id="basic-addon1">방번호</span> <input
                     type="text" class="form-control"
                     aria-label="Username" aria-describedby="basic-addon1"
                     name="roomNum_room" readonly value="${roomvo.roomNum_room }" >
               </div>
               <div class="input-group mb-3">
                  <span class="input-group-text" id="basic-addon1">방 정보</span> <input
                     type="text" class="form-control"
                     aria-label="Username" aria-describedby="basic-addon1"
                     name="info_room" value = "${roomvo.info_room }">
               </div>
               
               <div class="input-group-text">
						<span class="input-group-text" id="basic-addon1">입실시간</span>
						<input class="form-control" type="time"  value="${roomvo.checkIn_room }" min="13:00:00" max="16:00:00" name="checkIn_room">
					</div>
					<div class="input-group-text">
						<span class="input-group-text" id="basic-addon1">퇴실시간</span>
						<input class="form-control" type="time" value="${roomvo.checkOut_room }" min="11:00:00" max="12:00:00" name="checkOut_room">
					</div>
               ...
               <div class="input-group mb-3" >
                ...
                <input type="submit"
                  value="수정" style="margin-top: 15px;"
